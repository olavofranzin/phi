...
|---|---|---|---|
| **F1** | **Todo cliente que contrata tráfego aparece no PHI sem ninguém precisar lembrar** | *"todos os que contratarem"* + *"eu cadastro no Notion"* | 🟡 **caminho construído (Fase A, 21-22/09), prova pendente** — o CHA teve a campanha concluída em 22/09 e não há cliente novo para exercer o CA3. **O F1 só fecha com um cliente real entrando**.<br>🟢 **[26/09] a falha deixou de ser silenciosa:** o **V3** do vigia pergunta todo dia *"todo cliente ATIVO com Google/Meta Ads aparece no score?"*. **O defeito continua — mas agora grita no dia seguinte, em vez de sumir** |
